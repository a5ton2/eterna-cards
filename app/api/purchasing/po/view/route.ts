...
export async function GET() {
  try {
    ...
    const [suppliersRaw, purchaseOrdersRaw, poLinesRaw, productsRaw, inventoryRaw, transitRaw, invoicesRaw] = await Promise.all([
      supabase.from('suppliers').select('*').then(({ data }) => data || []),
      supabase.from('purchaseorders').select('*').then(({ data }) => data || []),
      supabase.from('polines').select('*').then(({ data }) => data || []),
      ...
      supabase.from('invoices').select('*').then(({ data }) => data || []),
    ]);
